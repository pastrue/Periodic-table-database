...
INSERT INTO public.properties VALUES (11, 22.99, 97.794, 882.94, 1);
...
--
-- Name: elements unique_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_key UNIQUE (symbol, name);
